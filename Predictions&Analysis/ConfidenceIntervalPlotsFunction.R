...
# ODE_Model_Function.stan is a stan function file necessary to simulate the model for each experimental profile

ConfidenceInterval <- function(experiment, aditInfo = "", stanRes){
  ...
  write.table(resPlotR, file = paste("ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_RFP.csv", sep = ""), col.names = TRUE, sep = ",")
  write.table(resPlotG, file = paste("ODEs_ConfInter_Params", stanRes, "_Exper",experiment,"_GFP.csv", sep = ""), col.names = TRUE, sep = ",")
